...
using namespace std;
using namespace oprofppoptions;

namespace oprofppoptions {
	int counter_mask;
...
namespace oprofppoptions{
	...
	popt::option options_array[] = {
		popt::option(oprofppoptions::sample_file, "samples-file", 'f', "image sample file", "file"),
		popt::option(oprofppoptions::image_file, "image-file", 'i', "image file", "file"),
		popt::option(oprofppoptions::demangle, "demangle", 'd', "demangle GNU C++ symbol names"),
		popt::option(oprofppoptions::demangle_and_shrink, "smart-demangle", 'D', "demangle GNU C++ symbol names then pass them through regular expression to shrink them"),
		popt::option(oprofppoptions::exclude_symbols, "exclude-symbol", 'e', "exclude these comma separated symbols", "symbol_name"),
		popt::option(oprofppoptions::sort_by_counter, "sort", 'C', "which counter to use for sampels sort", "counter nr"),
		popt::option(oprofppoptions::gprof_file, "dump-gprof-file", 'g', "dump gprof format file", "file"),
		popt::option(oprofppoptions::symbol, "list-symbol", 's', "give detailed samples for a symbol", "symbol"),
		popt::option(oprofppoptions::list_symbols, "list-symbols", 'l', "list samples by symbol"),
		popt::option(oprofppoptions::output_linenr_info, "output-linenr-info", 'o', "output filename:linenr info"),
		popt::option(oprofppoptions::reverse_sort, "reverse", 'r', "reverse sort order"),
		popt::option(oprofppoptions::show_shared_libs, "show-shared-libs", 'k', "show details for shared libraries"),
		popt::option(oprofppoptions::list_all_symbols_details, "list-all-symbols-details", 'L', "list samples for all symbols"),
	...
	*/
	...
	//} // namespace anon
	//JYY: Move get_options into namespace oprofppoptions to
	// avoid CodeAnalyst linking problem
