...
//	m_bUpperCase = true;
	...
	m_extensions = 0xffffffffffffffffULL;
	m_dbit = true;
	m_bShowSize = false;
...
const char *CDisassembler::S_ymmx_regs[]		= { "ymm0", "ymm1", "ymm2", "ymm3", "ymm4", "ymm5", "ymm6", "ymm7",
													"ymm8", "ymm9", "ymm10", "ymm11", "ymm12", "ymm13", "ymm14", "ymm15",
													"ymm16", "ymm17", "ymm18", "ymm19", "ymm20", "ymm21", "ymm22", "ymm23",
													"ymm24", "ymm25", "ymm26", "ymm27", "ymm28", "ymm29", "ymm30", "ymm31" };
const char *CDisassembler::S_vr_regs[]			= { "vr0", "vr1", "vr2", "vr3", "vr4", "vr5", "vr6", "vr7",
													"vr8", "vr9", "vr10", "vr11", "vr12", "vr13", "v14", "vr15",
													"vr16", "vr17", "vr18", "vr19", "vr20", "vr21", "vr22", "vr23",
													"vr24", "vr25", "vr26", "vr27", "vr28", "vr29", "vr30", "vr31" };


const char *CDisassembler::S_size_qualifiers[]	= { "byte ", "word ", "dword ", "fword ", "qword ", "tword ", "dqword ", "qqword" };
...
void CDisassembler::MemoryModrmStrWithSIB()
{
	...
	if( m_bHasIndex )
	{
		if((m_index >= REG_VR0) && (m_index < REG_VR31))
			strcat( idx_str, S_vr_regs[m_index - REG_VR0] );
		else
...
{
	if( m_modrm_mod == 3 )
		strcat( m_mnem, GetXymmStr(m_pOperand) );
	else
		MemoryModrmStr();
}
...
const char* CDisassembler::GetXymmStr(COperandInfo* op)
{
	const char** mmregs = (op->regBlock == REG_YMM0) ? S_ymmx_regs : S_xmmx_regs;
...
void CDisassembler::GetSimdOwordIs4()
{
	...
	m_pOperand->reg = IsLongMode() ? (m_immd >> 4) : ((m_immd >> 4) & 0x07);
}
...
bool CDisassembler::TablesHooked()
{
	try
	{
		...
		for( i = 0; i < 8; i++ )
		{
			...
			CheckHook( S_group_1_8e_tbl[i], "S_group_1_8e_tbl" );
			CheckHook( S_group_1_8f_tbl[i], "S_group_1_8f_tbl" );
			CheckHook( S_group_1_c6_tbl[i], "S_group_1_c6_tbl" );
			CheckHook( S_group_1_c7_tbl[i], "S_group_1_c7_tbl" );
			CheckHook( S_group_2_78_66_tbl[i], "S_group_2_78_66_tbl" );
		}
		...
		for( i = 0; i < 9; i++ )
		{
			...
			CheckHook( S_group_2_01_02_tbl[i], "S_group_2_01_02_tbl" );
		...
		for( i = 0; i < 4; i++ )
		{
			CheckHook( S_group_2_01_01_00_tbl[i], "S_group_2_01_01_00_tbl" );
			CheckHook( S_group_2_01_01_01_tbl[i], "S_group_2_01_01_01_tbl" );
			CheckHook( S_group_2_01_02_000_tbl[i], "S_group_2_01_02_000_tbl" );
			CheckHook( S_group_2_01_02_001_tbl[i], "S_group_2_01_02_001_tbl" );
		}
		...
		for( i = 0; i < 2; i++ )
		{
			...
			CheckHook( S_group_2_38_10_tbl[i], "S_group_2_38_10_tbl" );
			CheckHook( S_group_2_38_14_tbl[i], "S_group_2_38_14_tbl" );
			CheckHook( S_group_2_38_15_tbl[i], "S_group_2_38_15_tbl" );
			...
			CheckHook( S_group_2_38_20_tbl[i], "S_group_2_38_20_tbl" );
			CheckHook( S_group_2_38_21_tbl[i], "S_group_2_38_21_tbl" );
			CheckHook( S_group_2_38_22_tbl[i], "S_group_2_38_22_tbl" );
			CheckHook( S_group_2_38_23_tbl[i], "S_group_2_38_23_tbl" );
			CheckHook( S_group_2_38_24_tbl[i], "S_group_2_38_24_tbl" );
			CheckHook( S_group_2_38_25_tbl[i], "S_group_2_38_25_tbl" );
			CheckHook( S_group_2_38_28_tbl[i], "S_group_2_38_28_tbl" );
			CheckHook( S_group_2_38_29_tbl[i], "S_group_2_38_29_tbl" );
			CheckHook( S_group_2_38_2a_tbl[i], "S_group_2_38_2a_tbl" );
			CheckHook( S_group_2_38_2b_tbl[i], "S_group_2_38_2b_tbl" );
			CheckHook( S_group_2_38_30_tbl[i], "S_group_2_38_30_tbl" );
			CheckHook( S_group_2_38_31_tbl[i], "S_group_2_38_31_tbl" );
			CheckHook( S_group_2_38_32_tbl[i], "S_group_2_38_32_tbl" );
			CheckHook( S_group_2_38_33_tbl[i], "S_group_2_38_33_tbl" );
			CheckHook( S_group_2_38_34_tbl[i], "S_group_2_38_34_tbl" );
			CheckHook( S_group_2_38_35_tbl[i], "S_group_2_38_35_tbl" );
			CheckHook( S_group_2_38_37_tbl[i], "S_group_2_38_37_tbl" );
			CheckHook( S_group_2_38_38_tbl[i], "S_group_2_38_38_tbl" );
			CheckHook( S_group_2_38_39_tbl[i], "S_group_2_38_39_tbl" );
			CheckHook( S_group_2_38_3a_tbl[i], "S_group_2_38_3a_tbl" );
			CheckHook( S_group_2_38_3b_tbl[i], "S_group_2_38_3b_tbl" );
			CheckHook( S_group_2_38_3c_tbl[i], "S_group_2_38_3c_tbl" );
			CheckHook( S_group_2_38_3d_tbl[i], "S_group_2_38_3d_tbl" );
			CheckHook( S_group_2_38_3e_tbl[i], "S_group_2_38_3e_tbl" );
			CheckHook( S_group_2_38_3f_tbl[i], "S_group_2_38_3f_tbl" );
			CheckHook( S_group_2_38_40_tbl[i], "S_group_2_38_40_tbl" );
			CheckHook( S_group_2_38_41_tbl[i], "S_group_2_38_41_tbl" );
			CheckHook( S_group_2_38_82_tbl[i], "S_group_2_38_82_tbl" );
			CheckHook( S_group_2_38_db_tbl[i], "S_group_2_3a_db_tbl" );
			CheckHook( S_group_2_38_dc_tbl[i], "S_group_2_3a_dc_tbl" );
			CheckHook( S_group_2_38_dd_tbl[i], "S_group_2_3a_dd_tbl" );
			CheckHook( S_group_2_38_de_tbl[i], "S_group_2_3a_de_tbl" );
			CheckHook( S_group_2_38_df_tbl[i], "S_group_2_3a_df_tbl" );
		}

		for( i = 0; i < 3; i++)
		{
			CheckHook( S_group_2_38_f0_tbl[i], "S_group_2_38_f0_tbl" );
			CheckHook( S_group_2_38_f1_tbl[i], "S_group_2_38_f1_tbl" );
			CheckHook( S_group_2_c7_06_tbl[i], "S_group_2_c7_06_tbl" );
		}
		...
		for( i = 0; i < 2; i++ )
		{
			CheckHook( S_group_2_3a_08_tbl[i], "S_group_2_3a_08_tbl" );
			CheckHook( S_group_2_3a_09_tbl[i], "S_group_2_3a_09_tbl" );
			CheckHook( S_group_2_3a_0a_tbl[i], "S_group_2_3a_0a_tbl" );
			CheckHook( S_group_2_3a_0b_tbl[i], "S_group_2_3a_0b_tbl" );
			CheckHook( S_group_2_3a_0c_tbl[i], "S_group_2_3a_0c_tbl" );
			CheckHook( S_group_2_3a_0d_tbl[i], "S_group_2_3a_0d_tbl" );
			CheckHook( S_group_2_3a_0e_tbl[i], "S_group_2_3a_0e_tbl" );
			CheckHook( S_group_2_3a_0f_tbl[i], "S_group_2_3a_0f_tbl" );
			CheckHook( S_group_2_3a_14_tbl[i], "S_group_2_3a_14_tbl" );
			CheckHook( S_group_2_3a_15_tbl[i], "S_group_2_3a_15_tbl" );
			CheckHook( S_group_2_3a_16_tbl[i], "S_group_2_3a_16_tbl" );
			CheckHook( S_group_2_3a_16_00_tbl[i], "S_group_2_3a_16_00_tbl" );
			CheckHook( S_group_2_3a_17_tbl[i], "S_group_2_3a_17_tbl" );
			CheckHook( S_group_2_3a_20_tbl[i], "S_group_2_3a_20_tbl" );
			CheckHook( S_group_2_3a_21_tbl[i], "S_group_2_3a_21_tbl" );
			CheckHook( S_group_2_3a_22_tbl[i], "S_group_2_3a_22_tbl" );
			CheckHook( S_group_2_3a_22_00_tbl[i], "S_group_2_3a_22_00_tbl" );
			CheckHook( S_group_2_3a_40_tbl[i], "S_group_2_3a_40_tbl" );
			CheckHook( S_group_2_3a_41_tbl[i], "S_group_2_3a_41_tbl" );
			CheckHook( S_group_2_3a_42_tbl[i], "S_group_2_3a_42_tbl" );
			CheckHook( S_group_2_3a_44_tbl[i], "S_group_2_3a_44_tbl" );
			CheckHook( S_group_2_3a_60_tbl[i], "S_group_2_3a_60_tbl" );
			CheckHook( S_group_2_3a_61_tbl[i], "S_group_2_3a_61_tbl" );
			CheckHook( S_group_2_3a_62_tbl[i], "S_group_2_3a_62_tbl" );
			CheckHook( S_group_2_3a_63_tbl[i], "S_group_2_3a_63_tbl" );
			CheckHook( S_group_2_3a_df_tbl[i], "S_group_2_3a_df_tbl" );
		}
		...
		for( i = 0; i < 8; i++ )
		{
			...
			CheckHook( S_vex_m2_np_f3_tbl[i], "S_vex_m2_np_f3_tbl" );
			CheckHook( S_xop_m9_00_tbl[i], "S_vex_m9_00_tbl" );
			CheckHook( S_xop_m9_01_tbl[i], "S_vex_m9_01_tbl" );
			CheckHook( S_xop_m9_02_tbl[i], "S_vex_m9_02_tbl" );
			CheckHook( S_xop_ma_12_tbl[i], "S_vex_ma_12_tbl" );
		}
		...
		for( i = 0; i < 4; i++ )
		{
			...
			CheckHook( S_group_2_77_tbl[i], "S_group_2_77_tbl" );
		...
		for( i = 0; i < 16; i++ )
		{
			CheckHook( S_group_2_ae_np_tbl[i], "S_group_2_ae_np_tbl" );
			CheckHook( S_group_2_ae_f3_tbl[i], "S_group_2_ae_f3_tbl" );
			CheckHook( S_vex_m1_np_ae_tbl[i], "S_vex_m1_np_ae_tbl" );
			CheckHook( S_vex_m1_66_71_tbl[i], "S_vex_m1_66_71_tbl" );
			CheckHook( S_vex_m1_66_72_tbl[i], "S_vex_m1_66_72_tbl" );
			CheckHook( S_vex_m1_66_73_tbl[i], "S_vex_m1_66_73_tbl" );
			CheckHook( S_xop_m9_12_tbl[i], "S_vex_m9_12_tbl" );
		}

		for( i = 0; i < 2; i++)
		{
			CheckHook( S_group_2_ae_f3_m3r0_tbl[i], "S_group_2_ae_f3_m3r0_tbl" );
			CheckHook( S_group_2_ae_f3_m3r1_tbl[i], "S_group_2_ae_f3_m3r1_tbl" );
			CheckHook( S_group_2_ae_f3_m3r2_tbl[i], "S_group_2_ae_f3_m3r2_tbl" );
			CheckHook( S_group_2_ae_f3_m3r3_tbl[i], "S_group_2_ae_f3_m3r3_tbl" );
			CheckHook( S_group_2_01_07_m3rm0_tbl[i], "S_group_2_01_07_m3rm0_tbl" );
		}
		...
		for( i = 0; i < 2; i++ )
		{
			CheckHook( S_group_2_bc_tbl[i], "S_group_2_bc_tbl" );
		...
		for( i = 0; i < 4; i++ )
		{
			...
			CheckHook( S_group_2_c3_tbl[i], "S_group_2_c3_tbl" );
		...
		for( i = 0; i < 2; i++ )
			CheckHook( S_group_2_c7_01_tbl[i], "S_group_2_c7_01_tbl");
		...
		for( i = 0; i < 256; i++ )
		{
			CheckHook( S_vex_m1_np_tbl[i], "S_vex_m1_np_tbl" );
			CheckHook( S_vex_m1_66_tbl[i], "S_vex_m1_66_tbl" );
			CheckHook( S_vex_m1_f2_tbl[i], "S_vex_m1_f2_tbl" );
			CheckHook( S_vex_m1_f3_tbl[i], "S_vex_m1_f3_tbl" );
			CheckHook( S_vex_m2_np_tbl[i], "S_vex_m2_np_tbl" );
			CheckHook( S_vex_m2_66_tbl[i], "S_vex_m2_66_tbl" );
			CheckHook( S_vex_m2_f2_tbl[i], "S_vex_m2_f2_tbl" );
			CheckHook( S_vex_m2_f3_tbl[i], "S_vex_m2_f3_tbl" );
			CheckHook( S_vex_m3_np_tbl[i], "S_vex_m3_np_tbl" );
			CheckHook( S_vex_m3_66_tbl[i], "S_vex_m3_66_tbl" );
			CheckHook( S_vex_m3_f2_tbl[i], "S_vex_m3_f2_tbl" );
			CheckHook( S_vex_m3_f3_tbl[i], "S_vex_m3_f3_tbl" );
			CheckHook( S_xop_m8_tbl[i], "S_xop_m8_tbl" );
			CheckHook( S_xop_m9_tbl[i], "S_xop_m9_tbl" );
			CheckHook( S_xop_ma_tbl[i], "S_xop_ma_tbl" );
		}

		for( i = 0; i < 2; i++)
		{
			CheckHook( S_vex_m1_np_12_tbl[i], "S_vex_m1_np_12_tbl" );
			CheckHook( S_vex_m1_np_16_tbl[i], "S_vex_m1_np_16_tbl" );
			CheckHook( S_vex_m1_np_77_tbl[i], "S_vex_m1_np_77_tbl" );
			CheckHook( S_vex_m1_66_60_tbl[i], "S_vex_m1_66_60_tbl" );
			CheckHook( S_vex_m1_66_61_tbl[i], "S_vex_m1_66_61_tbl" );
			CheckHook( S_vex_m1_66_62_tbl[i], "S_vex_m1_66_62_tbl" );
			CheckHook( S_vex_m1_66_63_tbl[i], "S_vex_m1_66_63_tbl" );
			CheckHook( S_vex_m1_66_64_tbl[i], "S_vex_m1_66_64_tbl" );
			CheckHook( S_vex_m1_66_65_tbl[i], "S_vex_m1_66_65_tbl" );
			CheckHook( S_vex_m1_66_66_tbl[i], "S_vex_m1_66_66_tbl" );
			CheckHook( S_vex_m1_66_67_tbl[i], "S_vex_m1_66_67_tbl" );
			CheckHook( S_vex_m1_66_68_tbl[i], "S_vex_m1_66_68_tbl" );
			CheckHook( S_vex_m1_66_69_tbl[i], "S_vex_m1_66_69_tbl" );
			CheckHook( S_vex_m1_66_6a_tbl[i], "S_vex_m1_66_6a_tbl" );
			CheckHook( S_vex_m1_66_6b_tbl[i], "S_vex_m1_66_6b_tbl" );
			CheckHook( S_vex_m1_66_6c_tbl[i], "S_vex_m1_66_6c_tbl" );
			CheckHook( S_vex_m1_66_6d_tbl[i], "S_vex_m1_66_6d_tbl" );
			CheckHook( S_vex_m1_66_6e_tbl[i], "S_vex_m1_66_6e_tbl" );
			CheckHook( S_vex_m1_66_70_tbl[i], "S_vex_m1_66_70_tbl" );
			CheckHook( S_vex_m1_66_74_tbl[i], "S_vex_m1_66_74_tbl" );
			CheckHook( S_vex_m1_66_75_tbl[i], "S_vex_m1_66_75_tbl" );
			CheckHook( S_vex_m1_66_76_tbl[i], "S_vex_m1_66_76_tbl" );
			CheckHook( S_vex_m1_66_7e_tbl[i], "S_vex_m1_66_7e_tbl" );
			CheckHook( S_vex_m1_66_d1_tbl[i], "S_vex_m1_66_d1_tbl" );
			CheckHook( S_vex_m1_66_d2_tbl[i], "S_vex_m1_66_d2_tbl" );
			CheckHook( S_vex_m1_66_d3_tbl[i], "S_vex_m1_66_d3_tbl" );
			CheckHook( S_vex_m1_66_d4_tbl[i], "S_vex_m1_66_d4_tbl" );
			CheckHook( S_vex_m1_66_d5_tbl[i], "S_vex_m1_66_d5_tbl" );
			CheckHook( S_vex_m1_66_d7_tbl[i], "S_vex_m1_66_d7_tbl" );
			CheckHook( S_vex_m1_66_d8_tbl[i], "S_vex_m1_66_d8_tbl" );
			CheckHook( S_vex_m1_66_d9_tbl[i], "S_vex_m1_66_d9_tbl" );
			CheckHook( S_vex_m1_66_da_tbl[i], "S_vex_m1_66_da_tbl" );
			CheckHook( S_vex_m1_66_db_tbl[i], "S_vex_m1_66_db_tbl" );
			CheckHook( S_vex_m1_66_dc_tbl[i], "S_vex_m1_66_dc_tbl" );
			CheckHook( S_vex_m1_66_dd_tbl[i], "S_vex_m1_66_dd_tbl" );
			CheckHook( S_vex_m1_66_de_tbl[i], "S_vex_m1_66_de_tbl" );
			CheckHook( S_vex_m1_66_df_tbl[i], "S_vex_m1_66_df_tbl" );
			CheckHook( S_vex_m1_66_e0_tbl[i], "S_vex_m1_66_e0_tbl" );
			CheckHook( S_vex_m1_66_e1_tbl[i], "S_vex_m1_66_e1_tbl" );
			CheckHook( S_vex_m1_66_e2_tbl[i], "S_vex_m1_66_e2_tbl" );
			CheckHook( S_vex_m1_66_e3_tbl[i], "S_vex_m1_66_e3_tbl" );
			CheckHook( S_vex_m1_66_e4_tbl[i], "S_vex_m1_66_e4_tbl" );
			CheckHook( S_vex_m1_66_e5_tbl[i], "S_vex_m1_66_e5_tbl" );
			CheckHook( S_vex_m1_66_e8_tbl[i], "S_vex_m1_66_e8_tbl" );
			CheckHook( S_vex_m1_66_e9_tbl[i], "S_vex_m1_66_e9_tbl" );
			CheckHook( S_vex_m1_66_ea_tbl[i], "S_vex_m1_66_ea_tbl" );
			CheckHook( S_vex_m1_66_eb_tbl[i], "S_vex_m1_66_eb_tbl" );
			CheckHook( S_vex_m1_66_ec_tbl[i], "S_vex_m1_66_ec_tbl" );
			CheckHook( S_vex_m1_66_ed_tbl[i], "S_vex_m1_66_ed_tbl" );
			CheckHook( S_vex_m1_66_ee_tbl[i], "S_vex_m1_66_ee_tbl" );
			CheckHook( S_vex_m1_66_ef_tbl[i], "S_vex_m1_66_ef_tbl" );
			CheckHook( S_vex_m1_66_f1_tbl[i], "S_vex_m1_66_f1_tbl" );
			CheckHook( S_vex_m1_66_f2_tbl[i], "S_vex_m1_66_f2_tbl" );
			CheckHook( S_vex_m1_66_f3_tbl[i], "S_vex_m1_66_f3_tbl" );
			CheckHook( S_vex_m1_66_f4_tbl[i], "S_vex_m1_66_f4_tbl" );
			CheckHook( S_vex_m1_66_f5_tbl[i], "S_vex_m1_66_f5_tbl" );
			CheckHook( S_vex_m1_66_f6_tbl[i], "S_vex_m1_66_f6_tbl" );
			CheckHook( S_vex_m1_66_f7_tbl[i], "S_vex_m1_66_f7_tbl" );
			CheckHook( S_vex_m1_66_f8_tbl[i], "S_vex_m1_66_f8_tbl" );
			CheckHook( S_vex_m1_66_f9_tbl[i], "S_vex_m1_66_f9_tbl" );
			CheckHook( S_vex_m1_66_fa_tbl[i], "S_vex_m1_66_fa_tbl" );
			CheckHook( S_vex_m1_66_fb_tbl[i], "S_vex_m1_66_fb_tbl" );
			CheckHook( S_vex_m1_66_fc_tbl[i], "S_vex_m1_66_fc_tbl" );
			CheckHook( S_vex_m1_66_fd_tbl[i], "S_vex_m1_66_fd_tbl" );
			CheckHook( S_vex_m1_66_fe_tbl[i], "S_vex_m1_66_fe_tbl" );
			CheckHook( S_vex_m1_f3_10_tbl[i], "S_vex_m1_f3_10_tbl" );
			CheckHook( S_vex_m1_f3_11_tbl[i], "S_vex_m1_f3_11_tbl" );
			CheckHook( S_vex_m1_f3_70_tbl[i], "S_vex_m1_f3_70_tbl" );
			CheckHook( S_vex_m1_f2_10_tbl[i], "S_vex_m1_f2_10_tbl" );
			CheckHook( S_vex_m1_f2_11_tbl[i], "S_vex_m1_f2_11_tbl" );
			CheckHook( S_vex_m1_f2_70_tbl[i], "S_vex_m1_f2_70_tbl" );
			CheckHook( S_vex_m2_66_00_tbl[i], "S_vex_m2_66_00_tbl" );
			CheckHook( S_vex_m2_66_01_tbl[i], "S_vex_m2_66_01_tbl" );
			CheckHook( S_vex_m2_66_02_tbl[i], "S_vex_m2_66_02_tbl" );
			CheckHook( S_vex_m2_66_03_tbl[i], "S_vex_m2_66_03_tbl" );
			CheckHook( S_vex_m2_66_04_tbl[i], "S_vex_m2_66_04_tbl" );
			CheckHook( S_vex_m2_66_05_tbl[i], "S_vex_m2_66_05_tbl" );
			CheckHook( S_vex_m2_66_06_tbl[i], "S_vex_m2_66_06_tbl" );
			CheckHook( S_vex_m2_66_07_tbl[i], "S_vex_m2_66_07_tbl" );
			CheckHook( S_vex_m2_66_08_tbl[i], "S_vex_m2_66_08_tbl" );
			CheckHook( S_vex_m2_66_09_tbl[i], "S_vex_m2_66_09_tbl" );
			CheckHook( S_vex_m2_66_0a_tbl[i], "S_vex_m2_66_0a_tbl" );
			CheckHook( S_vex_m2_66_0b_tbl[i], "S_vex_m2_66_0b_tbl" );
			CheckHook( S_vex_m2_66_18_tbl[i], "S_vex_m2_66_18_tbl" );
			CheckHook( S_vex_m2_66_19_tbl[i], "S_vex_m2_66_19_tbl" );
			CheckHook( S_vex_m2_66_1c_tbl[i], "S_vex_m2_66_1c_tbl" );
			CheckHook( S_vex_m2_66_1d_tbl[i], "S_vex_m2_66_1d_tbl" );
			CheckHook( S_vex_m2_66_1e_tbl[i], "S_vex_m2_66_1e_tbl" );
			CheckHook( S_vex_m2_66_20_tbl[i], "S_vex_m2_66_20_tbl" );
			CheckHook( S_vex_m2_66_21_tbl[i], "S_vex_m2_66_21_tbl" );
			CheckHook( S_vex_m2_66_22_tbl[i], "S_vex_m2_66_22_tbl" );
			CheckHook( S_vex_m2_66_23_tbl[i], "S_vex_m2_66_23_tbl" );
			CheckHook( S_vex_m2_66_24_tbl[i], "S_vex_m2_66_24_tbl" );
			CheckHook( S_vex_m2_66_25_tbl[i], "S_vex_m2_66_25_tbl" );
			CheckHook( S_vex_m2_66_28_tbl[i], "S_vex_m2_66_28_tbl" );
			CheckHook( S_vex_m2_66_29_tbl[i], "S_vex_m2_66_29_tbl" );
			CheckHook( S_vex_m2_66_2a_tbl[i], "S_vex_m2_66_2a_tbl" );
			CheckHook( S_vex_m2_66_2b_tbl[i], "S_vex_m2_66_2b_tbl" );
			CheckHook( S_vex_m2_66_30_tbl[i], "S_vex_m2_66_30_tbl" );
			CheckHook( S_vex_m2_66_31_tbl[i], "S_vex_m2_66_31_tbl" );
			CheckHook( S_vex_m2_66_32_tbl[i], "S_vex_m2_66_32_tbl" );
			CheckHook( S_vex_m2_66_33_tbl[i], "S_vex_m2_66_33_tbl" );
			CheckHook( S_vex_m2_66_34_tbl[i], "S_vex_m2_66_34_tbl" );
			CheckHook( S_vex_m2_66_35_tbl[i], "S_vex_m2_66_35_tbl" );
			CheckHook( S_vex_m2_66_37_tbl[i], "S_vex_m2_66_37_tbl" );
			CheckHook( S_vex_m2_66_38_tbl[i], "S_vex_m2_66_38_tbl" );
			CheckHook( S_vex_m2_66_39_tbl[i], "S_vex_m2_66_39_tbl" );
			CheckHook( S_vex_m2_66_3a_tbl[i], "S_vex_m2_66_3a_tbl" );
			CheckHook( S_vex_m2_66_3b_tbl[i], "S_vex_m2_66_3b_tbl" );
			CheckHook( S_vex_m2_66_3c_tbl[i], "S_vex_m2_66_3c_tbl" );
			CheckHook( S_vex_m2_66_3d_tbl[i], "S_vex_m2_66_3d_tbl" );
			CheckHook( S_vex_m2_66_3e_tbl[i], "S_vex_m2_66_3e_tbl" );
			CheckHook( S_vex_m2_66_3f_tbl[i], "S_vex_m2_66_3f_tbl" );
			CheckHook( S_vex_m2_66_40_tbl[i], "S_vex_m2_66_40_tbl" );
			CheckHook( S_vex_m2_66_45_tbl[i], "S_vex_m2_66_45_tbl" );
			CheckHook( S_vex_m2_66_46_tbl[i], "S_vex_m2_66_46_tbl" );
			CheckHook( S_vex_m2_66_47_tbl[i], "S_vex_m2_66_47_tbl" );
			CheckHook( S_vex_m2_66_8c_tbl[i], "S_vex_m2_66_8c_tbl" );
			CheckHook( S_vex_m2_66_8e_tbl[i], "S_vex_m2_66_8e_tbl" );
			CheckHook( S_vex_m2_66_90_tbl[i], "S_vex_m2_66_90_tbl" );
			CheckHook( S_vex_m2_66_91_tbl[i], "S_vex_m2_66_91_tbl" );
			CheckHook( S_vex_m2_66_92_tbl[i], "S_vex_m2_66_92_tbl" );
			CheckHook( S_vex_m2_66_93_tbl[i], "S_vex_m2_66_93_tbl" );
			CheckHook( S_vex_m2_66_96_tbl[i], "S_vex_m2_66_96_tbl" );
			CheckHook( S_vex_m2_66_97_tbl[i], "S_vex_m2_66_97_tbl" );
			CheckHook( S_vex_m2_66_98_tbl[i], "S_vex_m2_66_98_tbl" );
			CheckHook( S_vex_m2_66_99_tbl[i], "S_vex_m2_66_99_tbl" );
			CheckHook( S_vex_m2_66_9a_tbl[i], "S_vex_m2_66_9a_tbl" );
			CheckHook( S_vex_m2_66_9b_tbl[i], "S_vex_m2_66_9b_tbl" );
			CheckHook( S_vex_m2_66_9c_tbl[i], "S_vex_m2_66_9c_tbl" );
			CheckHook( S_vex_m2_66_9d_tbl[i], "S_vex_m2_66_9d_tbl" );
			CheckHook( S_vex_m2_66_9e_tbl[i], "S_vex_m2_66_9e_tbl" );
			CheckHook( S_vex_m2_66_9f_tbl[i], "S_vex_m2_66_9f_tbl" );
			CheckHook( S_vex_m2_66_a6_tbl[i], "S_vex_m2_66_a6_tbl" );
			CheckHook( S_vex_m2_66_a7_tbl[i], "S_vex_m2_66_a7_tbl" );
			CheckHook( S_vex_m2_66_a8_tbl[i], "S_vex_m2_66_a8_tbl" );
			CheckHook( S_vex_m2_66_a9_tbl[i], "S_vex_m2_66_a9_tbl" );
			CheckHook( S_vex_m2_66_aa_tbl[i], "S_vex_m2_66_aa_tbl" );
			CheckHook( S_vex_m2_66_ab_tbl[i], "S_vex_m2_66_ab_tbl" );
			CheckHook( S_vex_m2_66_ac_tbl[i], "S_vex_m2_66_ac_tbl" );
			CheckHook( S_vex_m2_66_ad_tbl[i], "S_vex_m2_66_ad_tbl" );
			CheckHook( S_vex_m2_66_ae_tbl[i], "S_vex_m2_66_ae_tbl" );
			CheckHook( S_vex_m2_66_af_tbl[i], "S_vex_m2_66_af_tbl" );
			CheckHook( S_vex_m2_66_b6_tbl[i], "S_vex_m2_66_b6_tbl" );
			CheckHook( S_vex_m2_66_b7_tbl[i], "S_vex_m2_66_b7_tbl" );
			CheckHook( S_vex_m2_66_b8_tbl[i], "S_vex_m2_66_b8_tbl" );
			CheckHook( S_vex_m2_66_b9_tbl[i], "S_vex_m2_66_b9_tbl" );
			CheckHook( S_vex_m2_66_ba_tbl[i], "S_vex_m2_66_ba_tbl" );
			CheckHook( S_vex_m2_66_bb_tbl[i], "S_vex_m2_66_bb_tbl" );
			CheckHook( S_vex_m2_66_bc_tbl[i], "S_vex_m2_66_bc_tbl" );
			CheckHook( S_vex_m2_66_bd_tbl[i], "S_vex_m2_66_bd_tbl" );
			CheckHook( S_vex_m2_66_be_tbl[i], "S_vex_m2_66_be_tbl" );
			CheckHook( S_vex_m2_66_bf_tbl[i], "S_vex_m2_66_bf_tbl" );
			CheckHook( S_vex_m3_66_00_tbl[i], "S_vex_m2_66_00_tbl" );
			CheckHook( S_vex_m3_66_01_tbl[i], "S_vex_m2_66_01_tbl" );
			CheckHook( S_vex_m3_66_0e_tbl[i], "S_vex_m3_66_0e_tbl" );
			CheckHook( S_vex_m3_66_0f_tbl[i], "S_vex_m3_66_0f_tbl" );
			CheckHook( S_vex_m3_66_16_tbl[i], "S_vex_m3_66_16_tbl" );
			CheckHook( S_vex_m3_66_22_tbl[i], "S_vex_m3_66_22_tbl" );
			CheckHook( S_vex_m3_66_42_tbl[i], "S_vex_m3_66_42_tbl" );
			CheckHook( S_vex_m3_66_4c_tbl[i], "S_vex_m3_66_4c_tbl" );
		}
